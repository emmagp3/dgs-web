        ...
        <div className={`${styles.misionVisionSection} container`}>
          <div className={styles.misionVisionContent}>
            ...
            <p>
              ...
              en suministrar equipos de vanguardia con los mejores materiales de
              ...
              mercados y fortalecer nuestra posición en los ya existentes a
              través de alianzas estratégicas. Nos preocupamos por mantener una
              cultura organizacional basada en el desarrollo humano, la ética y
              el compromiso social, donde nuestro equipo de trabajo se sienta
